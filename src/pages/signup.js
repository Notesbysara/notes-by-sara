...
export default function SignupPage() {
  ...
  const mismatch = touched && confirmPassword && password !== confirmPassword;
  ...
  const handleSubmit = async (e) => {
    ...
    if (error) {
      ...
      setMessage({ type: 'success', text: 'Check your email to verify your account before logging in.' });
    }
  };

  return (
    <Layout title="Sign Up" description="Create an account on Notes by Sara">
        ...
        <div className={styles.rightPanel}>
          <div className={styles.card}>
            <div className={styles.tabs}>
              ...
              <span className={`${styles.tab} ${styles.tabActive}`}>Sign Up</span>
            </div>
            ...
            <div className={styles.divider}>
              ...
              <span className={styles.dividerText}>OR CREATE AN ACCOUNT</span>
              <div className={styles.dividerLine} />
            </div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <button type="submit" className={styles.submitBtn} disabled={submitting} style={{ marginTop: '1.25rem' }}>
                {submitting ? 'Creating account…' : 'Sign Up & Verify Email'}
              </button>
            </form>
          </div>
        </div>
